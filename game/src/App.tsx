...
// Define an error handler component with proper access to required variables
const ErrorHandlers = ({ 
  setNotification,
  assetErrorShown 
}: { 
  setNotification: (notification: any) => void, 
  assetErrorShown: React.MutableRefObject<boolean>
}) => {
  ...
  }, [setNotification, assetErrorShown]);
